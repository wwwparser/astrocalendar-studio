...
# Набор собран по подсказке наблюдателя: цветные кружки Telegram плюс 🪐 для
# Сатурна. Цвет привязан к тому, как планета выглядит в небе и в телескопе:
# Меркурий тёмный и малозаметный, Венера — самая белая, Марс красный, Юпитер
# оранжевый в полосах, ледяные гиганты синие. Уран и Нептун различаются формой
# значка, иначе в ленте их не отличить.
PLANET_ICONS = {
    "mercury": "⚫",
    "venus": "⚪",
    "mars": "🔴",
