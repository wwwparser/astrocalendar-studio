...
268 тестов: формат строк, астрономия против независимо известных значений,
...
обозначений, сверка двух источников) и живая лента: перевод расстояний NEO в лунные и пороги отбора,
