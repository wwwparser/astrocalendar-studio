...
- **Сближения околоземных астероидов:** список CNEOS, отбор по явным порогам
  ...
  время, скорость движения по небу.
- **Покрытия звёзд астероидами:** кандидаты из лент IOTA, полоса пересчитана
  ...
  возраст прогноза и возраст решения орбиты.
...
242 теста: формат строк, астрономия против независимо известных значений,
...
Отдельно покрыта живая лента: перевод расстояний NEO в лунные и пороги отбора,
